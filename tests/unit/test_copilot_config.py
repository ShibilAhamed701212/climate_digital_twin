...
class TestCopilotConfig:
    def test_load_defaults(self):
        ...
        assert config["llm"]["primary_model"] == "qwen:4b"
    ...
    def test_load_custom_config(self):
        ...
        custom = {
            "llm": {"primary_model": "custom-model", "temperature": 0.5, "max_tokens": 512, "context_window": 4096},
            ...
            "prompt_paths": {"intent_classification": "test.txt", "planning": "test.txt", "response_generation": "test.txt", "error_handling": "test.txt"},
            "performance_targets": {"simple_query_ms": 1000, "forecast_ms": 2000, "simulation_ms": 3000, "report_ms": 4000},
        }
