...
def _defaults() -> dict[str, Any]:
    return {
        "llm": {"primary_model": "qwen:4b", "temperature": 0.1, "max_tokens": 1024, "context_window": 8192},
        "memory": {"type": "conversation_buffer_window", "window_size": 10, "expiration_minutes": 60},
        "orchestration": {"max_iterations": 5, "return_intermediate_steps": True},
        "enabled_tools": [
            "forecast_tool", "digital_twin_tool", "scenario_simulator",
            "risk_assessor", "rag_retriever", "report_generator",
        ],
        "prompt_paths": {
        ...
        "performance_targets": {"simple_query_ms": 2000, "forecast_ms": 5000, "simulation_ms": 8000, "report_ms": 10000},
    }
